...
<%@page import="project.ConnectionProvider" %>
		...
		//ResultSet ps=st.executeQuery("select * from student where rollNo='"+rollNo+"' and password='"+password+"'");
  ...
  <table>
    ...
    <tfoot>
      <tr>
        ...
        <td>560</td>
        <td>180</td>
        <td><%int sum=rs.getInt(9)+rs.getInt(10)+rs.getInt(11)+rs.getInt(12)+rs.getInt(13)+rs.getInt(14)+rs.getInt(15); out.println(sum);%></td>
      </tr>
      <tr>
...
{
	response.sendRedirect("errorResultHome.html");
}
}
catch(Exception e)
{}
