...
<title>SMS</title>
<body>
<img src="gd1.jpg"  align="left"width="100" height="100">
<center><img src="sms_logo1.JPG" width="100" height="100">
...
<div class="w3-container">
  ...
  <div class="w3-bar w3-black">
    ...
    <button class="w3-bar-item w3-button tablink" onclick="openCity(event,'Paris')">Upload Marks</button>
    <button class="w3-bar-item w3-button tablink" onclick="openCity(event,'Tokyo')">View Students Details</button>
     <button class="w3-bar-item w3-button tablink" onclick="openCity(event,'Tokyo1')">All Student Result</button>
     <button class="w3-bar-item w3-button tablink" onclick="openCity(event,'japan')">Upload Attendance</button>
     <button class="w3-bar-item w3-button tablink" onclick="openCity(event,'London1')">Update Student Details</button>
...
<!-- Attendance Upload -->
  <div id="japan" class="w3-container w3-border city" style="display:none">
  <br>
  <link href="//maxcdn.bootstrapcdn.com/bootstrap/4.1.1/css/bootstrap.min.css" rel="stylesheet" id="bootstrap-css">
<script src="//maxcdn.bootstrapcdn.com/bootstrap/4.1.1/js/bootstrap.min.js"></script>
<script src="//cdnjs.cloudflare.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
...
<main class="my-form">
    <div class="cotainer">
        <div class="row justify-content-center">
            <div class="col-md-8">
                    <div class="card">
                        <div class="card-header">Upload Attendance</div>
                        <div class="card-body">
                            <form name="my-form" onsubmit="return validform()" action="attendance.jsp" method="">
                                <div class="form-group row">
                                    <label for="full_name" class="col-md-4 col-form-label text-md-right">Roll Number</label>
                                    <div class="col-md-6">
                                        <input type="text"class="form-control" name="rollNo">
                                ...
                                <div class="form-group row">
                                    <label for="email_address" class="col-md-4 col-form-label text-md-right">January</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="user_name" class="col-md-4 col-form-label text-md-right">February</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="phone_number" class="col-md-4 col-form-label text-md-right">March</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="present_address" class="col-md-4 col-form-label text-md-right">April</label>
                                    <div class="col-md-6">
...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.1.3/js/bootstrap.min.js"></script>
    ...
    <hr class="new1">
  <center><h5>Note: Any errors occur then contact <a href="https://mail.google.com/">team.sms@gmail.com</a>.
Designed & Developed Team Student Management Syestem</h5></center>
  <hr class="new1">
<center><h5>All Right Reserved @ Team Student Management System :: 2021</h5></center> 
  <hr class="new1">
<br>
</body>
</html>